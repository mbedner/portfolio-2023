...
//     query: GET_HOMEPAGE,
//   });
//   const homepage = response?.data?.page?.homepage;
//   return {
...
export async function getStaticProps() {
  ...
  // const { response: homepageresponse } = await client.query({
  //   query: GET_HOMEPAGE,
  // });

  // const { response: projectsresponse } = await client.query({
  //   query: GET_PROJECTS,
  // });

  // const homepage = homepageresponse?.data?.page?.homepage;
  // const projects = projectsresponse?.data?.projects?.nodes;
  // return {
  //   props: { homepage, projects }, // will be passed to the page component as props
  // };
